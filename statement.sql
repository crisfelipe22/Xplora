...
INSERT INTO categoria (nombre, descripcion, imagen) VALUES
    ('Aventuras y deportes', 'Actividades emocionantes al aire libre y deportes extremos para los amantes de la adrenalina.', '/imagen_25.jpeg'),
    ('Gastronomia', 'Experiencias culinarias que incluyen degustaciones, clases de cocina y cenas especiales.', '/imagen_26.jpeg'),
    ('Estadias', 'Alojamientos únicos y escapadas en hoteles, cabañas o estancias rurales.', '/imagen_27.jpeg'),
    ('Bienestar y relajación', 'Experiencias de spa, masajes y terapias de relajación para el descanso y el equilibrio.', '/imagen_28.jpeg'),
    ('Cultura y entretenimiento', 'Eventos culturales, visitas a museos, espectáculos y experiencias artísticas.', '/imagen_29.jpeg'),
    ('Naturaleza y ecoturismo', 'Actividades en entornos naturales como senderismo, avistamiento de fauna y ecoturismo.', '/imagen_30.jpeg'),
    ('Experiencias urbanas', 'Recorridos, actividades y eventos exclusivos en entornos urbanos vibrantes.', '/imagen_31.jpeg'),
    ('Romanticismo y arte', 'Experiencias diseñadas para parejas, incluyendo cenas románticas y actividades artísticas.', '/imagen_32.jpeg');
