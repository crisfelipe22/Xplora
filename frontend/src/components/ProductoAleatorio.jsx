...
const ProductoAleatorio = () => {
  ...
  const cantidadCategorias =
    screenSize === "mobile" ? 1 : screenSize === "tablet" ? 2 : 4;
    ...
    <>
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <Box
          ...
          sx={{ marginTop: 4 }}
        >
          <Typography variant="h5" className="titulo-recomendados" gutterBottom>
        ...
        {screenSize === "mobile" || screenSize === "tablet" ? (
          <Typography variant="body2" sx={{ marginY: 2 }}>
            {productosFiltrados.length} Experiencias
          </Typography>
        ) : (
          <></>
        )}
      ...
      <Box sx={{ Padding: 1 }} className={styles.gridContainer}>
        <Grid2 container spacing={4} columns={12}>
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      ...
                      onChange={() =>
                        handleCategoriaChange(categoria.id_categoria)
                      }
                    />
                  }
          ...
          {/* Productos */}
          <Grid2 size={{ mobile: 12, desktop: 9 }} container spacing={4}>
            {paginatedProducts.length > 0 ? (
              paginatedProducts.map((product) => (
                <Grid2
                  size={{ mobile: 12, tablet: 6, desktop: 4 }}
                  key={product.id_paquete_experiencia}
                >
