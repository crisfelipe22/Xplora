    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth ->{
                            ...
                            auth.requestMatchers(HttpMethod.GET, "/api/calificaciones").permitAll();
                            auth.requestMatchers(HttpMethod.GET, "/api/calificaciones/**").permitAll();
                            auth.requestMatchers(HttpMethod.PUT, "/api/calificaciones").hasAnyRole("Administrador", "SuperAdministrador");
                            auth.requestMatchers(HttpMethod.DELETE, "/api/calificaciones").hasAnyRole("Administrador", "SuperAdministrador");
                            auth.requestMatchers(HttpMethod.POST, "/api/calificaciones").hasAnyRole("Administrador", "SuperAdministrador");
